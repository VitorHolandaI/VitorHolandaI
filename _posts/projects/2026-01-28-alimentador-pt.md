...
Um projeto de eletrônica pessoal nascido de uma necessidade simples: manter meus pássaros alimentados mesmo quando estou fora de casa. Construído em torno de um Arduino Uno, o alimentador funciona completamente no próprio horário. Não precisa de app, internet ou intervenção manual.
