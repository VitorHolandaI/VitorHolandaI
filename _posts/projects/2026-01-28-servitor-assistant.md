...
A voice assistant split across two machines: a PC handles the heavy work, including speech recognition, LLM inference, and text-to-speech. A Raspberry Pi acts as the physical interface, listening through a microphone, playing back the response through speakers, and pulsing an LED while it waits.

The assistant has a Warhammer 40k Adeptus Mechanicus personality. It talks like a Magos from the Imperium: brief, curious, and slightly unnerving.
