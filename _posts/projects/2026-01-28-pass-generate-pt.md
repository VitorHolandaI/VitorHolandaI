...
Este pequeno programa em C gera uma frase-senha de 4 palavras usando exatamente esse método. Para cada palavra, você rola um dado 6 vezes, digita o resultado como número, e o programa busca a palavra correspondente em uma grande lista de palavras. Isso torna o resultado genuinamente aleatório sem depender de nenhum algoritmo para decidir. Você também escolhe o idioma de cada palavra de forma independente, entre Português, Inglês e Italiano, podendo misturar idiomas na mesma frase-senha.
