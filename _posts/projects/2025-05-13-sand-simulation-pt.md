...
Um projeto pessoal pequeno para explorar o canvas e o loop de eventos do Tkinter. A física ainda está em desenvolvimento, mas a simulação já parece e se comporta como areia.
